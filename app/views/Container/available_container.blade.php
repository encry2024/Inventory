...
$(document).ready( function() {
	...
	$.getJSON("{{ URL::to('/') }}/getAvailable/{{ $category->id }}",function(data) {
		$('#available').dataTable({
			"aaData": data,
			"aaSorting": [[ 3, 'desc' ]],
			"oLanguage": {
			...
			[
				...
				{"sTitle": "Availability", "mDataProp": "status"},
			...
			[
				...
				},
				{
					...
					return '<label class="text-center size-14 radius alert-box success alert-custom">' + full["availability"] + '</label>';
				}}},
				//dateofapplication
				{
